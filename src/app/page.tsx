                ...
                <div className="relative max-w-5xl mx-auto mt-2">
                    ...
                    <div className="bg-white rounded-lg shadow-lg border-6 border-[#7086d1] px-8 py-10 md:px-12 md:py-12 text-center">
                        ...
                        <Link
                            ...
                            className="inline-block bg-[#7086D1] text-white px-10 py-2 rounded-full font-semibold text-lg hover:bg-[#5A6BB5] transition-colors"
                        >
                            SAVE YOUR SPOT
                        </Link>
                        <p className="mt-4 font-black text-lg text-[#3A4A93] relative z-10">
